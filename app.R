              ...
              fluidRow(
                column(6,
                       ...
                       sliderInput(inputId = "CodFH_seas1", label ="For Hire Season 1",
                                   min = as.Date("2027-05-01","%Y-%m-%d"),
                                   max = as.Date("2028-04-30","%Y-%m-%d"),
                                   value =c(as.Date("2027-09-01","%Y-%m-%d"),as.Date("2027-10-31","%Y-%m-%d")),
                       ...
                       shinyjs::hidden( div(ID = "CodSeason2",
                                            sliderInput(inputId = "CodFH_seas2", label ="For Hire Season 2",
                                                        min = as.Date("2027-05-01","%Y-%m-%d"),
                                                        max = as.Date("2028-04-30","%Y-%m-%d"),
                                                        value=c(as.Date("2028-01-01","%Y-%m-%d"),as.Date("2028-01-01","%Y-%m-%d")),
                                                        timeFormat = "%Y-%m-%d", ticks = FALSE),
                                            fluidRow(
                                              column(4,
                                            ...
                                            sliderInput(inputId = "CodPR_seas2", label ="Private Season 2",
                                                        min = as.Date("2027-05-01","%Y-%m-%d"),
                                                        max = as.Date("2028-04-30","%Y-%m-%d"),
                                                        value=c(as.Date("2028-01-01","%Y-%m-%d"),as.Date("2028-01-01","%Y-%m-%d")),
                                                        timeFormat = "%Y-%m-%d", ticks = FALSE),
                ...
                column(6,
                       ...
                       sliderInput(inputId = "HadFH_seas1", label ="For Hire Season 1",
                                   min = as.Date("2027-05-01","%Y-%m-%d"),
                                   max = as.Date("2028-04-30","%Y-%m-%d"),
                                   value =c(as.Date("2027-05-01","%Y-%m-%d"),as.Date("2028-02-29","%Y-%m-%d")),
                                   timeFormat = "%Y-%m-%d", ticks = FALSE),
                       fluidRow(
                         column(4,
                       ...
                       sliderInput(inputId = "HadFH_seas2", label ="For Hire Season 2",
                                   min = as.Date("2027-05-01","%Y-%m-%d"),
                                   max = as.Date("2028-04-30","%Y-%m-%d"),
                                   value =c(as.Date("2028-04-01","%Y-%m-%d"),as.Date("2028-04-30","%Y-%m-%d")),
                                   timeFormat = "%Y-%m-%d", ticks = FALSE),
                       fluidRow(
                         column(4,
